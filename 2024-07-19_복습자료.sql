...
SELECT *
FROM CUSTOMER
WHERE BIRTHDATE < '1995/01/01' AND BIRTHDATE > '1986/01/01';
--WHERE EXTRACT(YEAR FROM SYSDATE) - EXTREACT(YEAR FROM BIRTHDATE) + 1 BETWEEN 30 AND 39;
